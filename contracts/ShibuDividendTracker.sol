...
contract ShibuDividendTracker is Ownable, DividendPayingToken {
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Shibu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Shibu contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Shibu_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Shibu_Dividend_Tracker: Cannot update claimWait to same value"
        );
